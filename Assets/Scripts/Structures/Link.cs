...
namespace TrafficSim
{
    public class Link
    {
        ...
        public void init()
        {
            ...
            td_link_out_flow_capacity = Convert.ToInt32(link_capacity / (60 * network.NUMBER_OF_SIMU_INTERVALS_PER_MIN)) * (network.LENGTH_OF_SIMULATION_TIME_HORIZON_IN_INTERVAL + 1);
            td_link_cumulative_arrival = network.LENGTH_OF_SIMULATION_TIME_HORIZON_IN_INTERVAL + 1;
            td_link_cumulative_departure = network.LENGTH_OF_SIMULATION_TIME_HORIZON_IN_INTERVAL + 1;
